...
module.exports = (router) => {
    ...
    router.get('/moretuijian', async ctx => {
        ctx.body = (await axios(`https://api.96friend.cn/videoLive!getRecommendList.htm?apptype=6&userid=26307780&pageno=1&type=1&pagesize=666&cversion=29011505`)).data
    })
    router.get('/morecaiyi', async ctx => {
        ctx.body = (await axios(`https://api.96friend.cn/videoLiveChannel!getChannelVideoLiveList.htm?apptype=6&userid=26307780&type=1&pageno=1&cversion=29011505`)).data
    })
